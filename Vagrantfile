Vagrant.configure("2") do |config|
  ...
  config.vm.provision :chef_client do |chef|
    ...
    chef.chef_server_url = "https://api.chef.io/organizations/rameshctschef"
    chef.validation_key_path = ".chef/rameshctschef.pem"
    chef.validation_client_name = "rameshctschef"
